...
final class StorageTest extends TestCase
{
    ...
    public function testLoad(): void
    {
        ...
        $loadedPayload = Storage::load($path);

        $this->assertSame($payload, $loadedPayload);
    }
     ...
     */
    #[Test]
    public function testLoadThrowsWhenFileNotFound(): void
    {
        $path = $this->tempDir . '/not_found.json';

        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessage("Failed to load JSON: file not found: {$path}");
    ...
    public function testLoadThrowsWhenJsonIsInvalid(): void
    {
        ...
        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessageMatches('/^Failed to load JSON from .*: /');
     ...
     */
    #[Test]
    public function testLoadThrowsWhenPayloadIsNotArray(): void
    {
     ...
     */
    #[Test]
    public function testLoadReturnsEmptyArrayForEmptyJsonObject(): void
    {
        $path = $this->tempDir . '/empty.json';
        file_put_contents($path, '{}');

        $this->assertSame([], Storage::load($path));
    }
}
